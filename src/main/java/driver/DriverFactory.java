...
//        String browserType = "chrome";  // moved to config.properties file

        switch (getBrowserType()) { // replace browserType with the new method getBrowserType()
            case "chrome" -> {
    ...
    private static String getBrowserType() { // don't use the exception, create your own
        String browserType = null;
        String browserTypeRemoteValue= System.getProperty("browserType"); // gets the value from Jenkins
